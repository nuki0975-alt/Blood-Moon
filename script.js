const characterDB = {
    ...
    choijongho: {
        name: "한지호", rank: "GEN 1 (혈체 강화형)", ether: "65%", combat: "80%", danger: "65%",
...
function openCharacterDetail(charId) {
    ...
    document.getElementById('detail-visual-box').innerHTML = `<img src="images/${char.name}.png" alt="${char.name}" class="char-img large-detail-img" onerror="this.parentElement.innerHTML='AWAITING VISUAL DATA...'">`;
